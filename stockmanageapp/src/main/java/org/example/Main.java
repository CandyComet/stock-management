...
public class Main {
    ...
    static void showLoginWindow() {
        ...
        emailL.setBounds(50, 40, 100, 25);
        emailF.setBounds(150, 40, 180, 25);
        passL.setBounds(50, 80, 100, 25);
        passF.setBounds(150, 80, 180, 25);
    ...
    static void showMainMenu() {
        ...
        manageAdmin.addActionListener(e -> {
            f.dispose();
            showAdminListWindow();
        });
    ...
    static void showImageFrame() {
        ...
        viewAllBtn.setBounds(180, 130, 180, 30);
        f.add(viewAllBtn);
    ...
    static void showMenu() {
        ...
        List<String> list = ap.getAllImageFiles();
        ...
        JFrame f = new JFrame("All Images");
        f.setSize(950, 650);
        f.setLocationRelativeTo(null);
        f.setLayout(new BorderLayout());

        JPanel top = new JPanel(null);
        top.setPreferredSize(new Dimension(950, 50));
    ...
    static void showAddProductWindow() {
        ...
        nameL.setBounds(50, 30, 120, 25);
        nameF.setBounds(180, 30, 150, 25);
        priceL.setBounds(350, 30, 120, 25);
        priceF.setBounds(480, 30, 100, 25);
        qtyL.setBounds(50, 80, 120, 25);
        qtyF.setBounds(180, 80, 150, 25);
        whL.setBounds(350, 80, 120, 25);
        whF.setBounds(480, 80, 100, 25);
    ...
    static void showStockListWindow() {
        ...
        JLabel l3 = new JLabel("Warehouse");
        ...
        l3.setOpaque(true);
        l4.setOpaque(true);
        l1.setBackground(cyan);
        l2.setBackground(cyan);
        l3.setBackground(cyan);
        l4.setBackground(cyan);
    ...
    static void showAdminListWindow() {
        ...
        l3.setBounds(370, 20, 120, 25);
        l4.setBounds(510, 20, 120, 25);
        jf.add(l1);
        jf.add(l2);
        jf.add(l3);
        jf.add(l4);
        ...
        List<AdminModel> all = ap.getAllAdmins();
        int startY = 0;
        for (AdminModel s : all) {
            JPanel row = new JPanel();
            row.setLayout(null);
            JTextField t1 = new JTextField(s.getUsername());
            JTextField t2 = new JTextField(s.getEmail());
            JTextField t3 = new JTextField(s.getPhone());
            JTextField t4 = new JTextField(s.getPassword());
            JButton del = new JButton("Delete");
            t1.setBounds(50, 5, 120, 25);
            t2.setBounds(200, 5, 150, 25);
            t3.setBounds(370, 5, 120, 25);
            t4.setBounds(510, 5, 120, 25);
            del.setBounds(640, 5, 80, 25);
            row.add(t1);
            row.add(t2);
            row.add(t3);
            row.add(t4);
            ...
            del.addActionListener(e -> {
                ...
                if (ok) {
                    ...
                    p.revalidate();
                    p.repaint();
                } else JOptionPane.showMessageDialog(jf, "Delete failed!");
            });
        ...
        JButton backBtn = new JButton("Back");
        backBtn.setBounds(20, 320, 100, 30);
        jf.add(backBtn);
        backBtn.addActionListener(e -> {
            jf.dispose();
            showMainMenu();
